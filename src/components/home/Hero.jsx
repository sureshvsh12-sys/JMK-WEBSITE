...
const trustPoints = [
  { label: "Trusted Guidance", icon: ShieldCheck },
  { label: "Transparent Process", icon: BadgeCheck },
  { label: "Across Madhya Pradesh", icon: MapPin },
];

export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-[#020b15] pt-[88px] text-white sm:pt-[104px]">
      <div
      ...
      />
      <div className="absolute inset-0 -z-20 bg-gradient-to-r from-[#020b15]/98 via-[#03111e]/94 to-[#020b15]/72" />
      ...
      <div className="mx-auto max-w-[1500px] px-5 pb-8 pt-10 sm:px-6 lg:px-10 lg:pt-12 xl:px-12 xl:pt-14">
        <div className="grid min-h-[650px] items-center gap-10 lg:grid-cols-[0.86fr_1.14fr] xl:gap-14">
          <div className="relative z-20 mx-auto max-w-[640px] text-center lg:mx-0 lg:text-left">
            ...
            <h1 className="reveal-delay mt-7 text-[clamp(3rem,6.3vw,6.4rem)] font-black leading-[0.94] tracking-[-0.055em] sm:mt-8">
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:justify-center lg:justify-start">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-3 rounded-full bg-green-500 px-8 py-4 font-black text-white shadow-lg shadow-green-500/20 transition duration-300 hover:-translate-y-1 hover:bg-green-600"
              >
          ...
          <div className="relative flex min-h-[430px] items-center justify-center sm:min-h-[520px] lg:min-h-[590px]">
            <div className="absolute inset-x-[12%] top-[17%] h-[56%] rounded-full bg-amber-400/10 blur-[105px]" />

            <div className="absolute left-2 top-[10%] z-30 hidden min-w-[210px] rounded-2xl border border-amber-400/35 bg-[#07111f]/95 p-5 shadow-2xl shadow-black/40 backdrop-blur-xl xl:block">
              <p className="text-xs font-black uppercase tracking-[0.18em] text-amber-400">One Group</p>
              <p className="mt-1 text-sm font-bold text-white">Three Trusted Divisions</p>
            </div>

            <div className="absolute bottom-[14%] right-[2%] z-30 hidden rounded-2xl border border-white/10 bg-[#07111f]/95 p-4 shadow-2xl shadow-black/40 backdrop-blur-xl xl:block">
              <div className="flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-green-500/15 text-green-400">
                  <BadgeCheck size={22} />
                </span>
                <span>
                  <strong className="block text-sm text-white">Professional Support</strong>
                  <small className="text-slate-400">From enquiry to execution</small>
                </span>
              </div>
            </div>

            <div className="relative z-10 flex w-full justify-center overflow-visible">
              <LogoMark size={520} animated className="w-full max-w-[520px]" />
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0">
                    <strong className="block text-lg font-black lg:text-xl">{division.title}</strong>
                    <span className="mt-2 block max-w-[270px] leading-6 text-slate-600">{division.description}</span>
                    <span className={`mt-3 inline-flex items-center gap-2 font-black ${division.linkClass}`}>
                      Explore
